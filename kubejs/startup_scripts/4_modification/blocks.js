...
const probablychests = ["probablychests:lush_chest", "probablychests:normal_chest", "probablychests:rocky_chest", "probablychests:stone_chest", "probablychests:gold_chest", "probablychests:shadow_chest", "probablychests:nether_chest", "probablychests:ice_chest", "minecraft:nether_portal"];
const norandomtick = ["minecraft:nether_portal", "minecraft:pointed_dripstone", "minecraft:budding_amethyst", "minecraft:vine", "minecraft:mud", "minecraft:brown_mushroom", "minecraft:red_mushroom", "minecraft:kelp", "minecraft:farmland"];
